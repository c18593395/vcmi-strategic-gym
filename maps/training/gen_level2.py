...
# Level 2 map generation script
# Based on gen_level1.py, adds weak monsters guarding mines/resources

src = "D:/Bigdata/hero3_fresh/Maps/train_v1.vmap"
dst_dir = "D:/Bigdata/hero3_fresh/Maps/training"
os.makedirs(dst_dir, exist_ok=True)

# Level 2 map definitions: (name, w, h, hero_x, hero_y, mine_x, mine_y, resources, monsters)
# resources: list of (x, y, type)
# monsters: list of (x, y, subtype, amount, aggression)
level2_maps = [
