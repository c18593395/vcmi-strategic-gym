...
# Level 3 map generation script
# Based on gen_level2.py, adds town economy, resources for building, medium monsters

src = "D:/Bigdata/hero3_fresh/Maps/train_v1.vmap"
dst_dir = "D:/Bigdata/hero3_fresh/Maps/training"
os.makedirs(dst_dir, exist_ok=True)

# Level 3 map definitions: (name, w, h, hero_x, hero_y, mine_x, mine_y, resources, monsters)
# resources: list of (x, y, type) - include wood and rare for building
# monsters: list of (x, y, subtype, amount, aggression) - medium strength
level3_maps = [
