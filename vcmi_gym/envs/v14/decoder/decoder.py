...
class Decoder:
    ...
    @classmethod
    def decode(cls, state, only_global=False, verbose=False) -> Battlefield:
        obs = state
    ...
    def decode_player(cls, playerdata, verbose):
        res = {}
        for attr, (enctype, offset, n, vmax, slope) in pyconnector.PLAYER_ATTR_MAP.items():
    ...
    def decode_hex(cls, hexdata, verbose=False):
        ...
        for attr, (enctype, offset, n, vmax, slope) in pyconnector.HEX_ATTR_MAP.items():
