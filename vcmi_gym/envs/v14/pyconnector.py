...
if (os.getenv("VCMIGYM_DEBUG", None) == "1"):
    from ...connectors.build import exporter_v14
else:
    from ...connectors.rel import exporter_v14

EXPORTER = exporter_v14.Exporter()
...
class PyConnector():
    ...
    def start_connector(self, **kwargs):
        ...
        if (os.getenv("VCMIGYM_DEBUG", None) == "1"):
            ...
            from ...connectors.build import connector_v14
        else:
