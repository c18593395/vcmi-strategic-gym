...
namespace Connector::V14::Thread {
    ...
    const MMAI::Schema::V14::ISupplementaryData* Connector::extractSupplementaryData(const MMAI::Schema::IState *s) {
        ...
        auto &t = typeid(const MMAI::Schema::V14::ISupplementaryData*);
        auto err = MMAI::Schema::AnyCastError(any, typeid(const MMAI::Schema::V14::ISupplementaryData*));

        if(!err.empty()) {
            LOGFMT("anycast for getSumpplementaryData error: %s", err);
        }

        return std::any_cast<const MMAI::Schema::V14::ISupplementaryData*>(s->getSupplementaryData());
    };
    ...
    const P_State Connector::convertState(const MMAI::Schema::IState* s) {
        ...
        assert(sup->getType() == MMAI::Schema::V14::ISupplementaryData::Type::REGULAR);
        ...
        for (const auto &[type, links] : sup->getAllLinks()) {
            ...
            switch(type) {
            break; case MMAI::Schema::V14::LinkType::ADJACENT:
                pytype = "ADJACENT";
            break; case MMAI::Schema::V14::LinkType::REACH:
                pytype = "REACH";
            break; case MMAI::Schema::V14::LinkType::RANGED_MOD:
                pytype = "RANGED_MOD";
            break; case MMAI::Schema::V14::LinkType::ACTS_BEFORE:
                pytype = "ACTS_BEFORE";
            break; case MMAI::Schema::V14::LinkType::MELEE_DMG_REL:
                pytype = "MELEE_DMG_REL";
            break; case MMAI::Schema::V14::LinkType::RETAL_DMG_REL:
                pytype = "RETAL_DMG_REL";
            break; case MMAI::Schema::V14::LinkType::RANGED_DMG_REL:
    ...
    const std::tuple<int, std::string> Connector::render(int side) {
        ...
        assert(sup->getType() == MMAI::Schema::V14::ISupplementaryData::Type::ANSI_RENDER);
